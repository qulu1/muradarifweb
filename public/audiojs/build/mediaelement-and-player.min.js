...
! function a(b, c, d) {
    ...
    6: [function(a, b, c) {
        ...
        var e = a(3),
            f = d(e),
            g = {};
        g.version = "3.0.2", g.html5media = {
            properties: ["volume", "src", "currentTime", "muted", "duration", "paused", "ended", "error", "currentSrc", "networkState", "preload", "buffered", "bufferedBytes", "bufferedTime", "readyState", "seeking", "initialTime", "startOffsetTime", "defaultPlaybackRate", "playbackRate", "played", "seekable", "autoplay", "loop", "controls"],
    ...
    8: [function(a, b, c) {
        ...
        Object.assign(m.config, {
            ...
            exitFullScreen: function() {
                ...
                clearTimeout(a.containerSizeTimeout), p.HAS_TRUE_NATIVE_FULLSCREEN && (p.IS_FULLSCREEN || a.isFullScreen) && p.cancelFullScreen(), $(i["default"].documentElement).removeClass(a.options.classPrefix + "fullscreen"), a.container.removeClass(a.options.classPrefix + "container-fullscreen"), a.options.setDimensions && (a.container.width(a.normalWidth).height(a.normalHeight), b ? a.$media.width(a.normalWidth).height(a.normalHeight) : a.container.find("iframe, embed, object, video").width(a.normalWidth).height(a.normalHeight), a.media.setSize(a.normalWidth, a.normalHeight), a.layers.children("div").width(a.normalWidth).height(a.normalHeight)), a.fullscreenBtn.removeClass(a.options.classPrefix + "unfullscreen").addClass(a.options.classPrefix + "fullscreen"), a.setControlsSize(), a.isFullScreen = !1, a.container.find("." + a.options.classPrefix + "captions-text").css("font-size", ""), a.container.find("." + a.options.classPrefix + "captions-text").css("line-height", ""), a.container.find("." + a.options.classPrefix + "captions-position").css("bottom", ""), a.container.trigger("exitedfullscreen")
            }
        })
    }, {
        16: 16,
        ...
        Object.assign(e.config, {
            ...
            buildprogress: function(a, b, c, d) {
                ...
                var o = function(b) {
                        var c = e.total.offset(),
                            ...
                            l = 0,
                            m = void 0;
                        m = b.originalEvent && b.originalEvent.changedTouches ? b.originalEvent.changedTouches[0].pageX : b.changedTouches ? b.changedTouches[0].pageX : b.pageX, d.duration && (m < c.left ? m = c.left : m > g + c.left && (m = g + c.left), l = m - c.left, h = l / g, k = .02 >= h ? 0 : h * d.duration, f && k.toFixed(4) !== d.currentTime.toFixed(4) && d.setCurrentTime(k), i.HAS_TOUCH || (e.timefloat.css("left", l), e.timefloatcurrent.html(j.secondsToTimeCode(k, a.options.alwaysShowHours)), e.timefloat.show()))
                    },
                    p = function() {
                        var b = d.currentTime,
                ...
                e.slider.on("focus", function() {
                    ...
                    d.duration !== 1 / 0 && (1 === a.which || 0 === a.which) && (f = !0, o(a), e.globalBind("mousemove.dur touchmove.dur", function(a) {
                        o(a)
                    }), e.globalBind("mouseup.dur touchend.dur", function() {
                        f = !1, void 0 !== e.timefloat && e.timefloat.hide(), e.globalUnbind("mousemove.dur touchmove.dur mouseup.dur touchend.dur")
                    }))
                }).on("mouseenter", function(a) {
                    d.duration !== 1 / 0 && (g = !0, e.globalBind("mousemove.dur", function(a) {
                        o(a)
                    }), void 0 === e.timefloat || i.HAS_TOUCH || e.timefloat.show())
                    ...
                    d.duration !== 1 / 0 ? (a.setProgressRail(c), a.setCurrentRail(c)) : b.find("." + e.options.classPrefix + "broadcast").length || b.find("." + e.options.classPrefix + "time-rail").empty().html('<span class="' + e.options.classPrefix + 'broadcast">' + mejs.i18n.t("mejs.live-broadcast") + "</span>")
                }, !1), d.addEventListener("timeupdate", function(c) {
                    d.duration !== 1 / 0 ? (a.setProgressRail(c), a.setCurrentRail(c), p(c)) : b.find("." + e.options.classPrefix + "broadcast").length || b.find("." + e.options.classPrefix + "time-rail").empty().html('<span class="' + e.options.classPrefix + 'broadcast">' + mejs.i18n.t("mejs.live-broadcast") + "</span>")
                }, !1), e.container.on("controlsresize", function(b) {
                    d.duration !== 1 / 0 && (a.setProgressRail(b), a.setCurrentRail(b))
                })
            },
            setProgressRail: function(a) {
                var b = this,
                    ...
                    d = null;
                c && c.buffered && c.buffered.length > 0 && c.buffered.end && c.duration ? d = c.buffered.end(c.buffered.length - 1) / c.duration : c && void 0 !== c.bytesTotal && c.bytesTotal > 0 && void 0 !== c.bufferedBytes ? d = c.bufferedBytes / c.bytesTotal : a && a.lengthComputable && 0 !== a.total && (d = a.loaded / a.total), null !== d && (d = Math.min(1, Math.max(0, d)),
                    b.loaded && b.total && b.loaded.width(100 * d + "%"))
            },
            setCurrentRail: function() {
                ...
                if (void 0 !== a.media.currentTime && a.media.duration && a.total && a.handle) {
                    ...
                    b = a.media.currentTime / a.media.duration * 100, a.current.width(b + "%"), a.handle.css("left", c)
                }
            }
        })
    }, {
    ...
    16: [function(a, b, c) {
            ...
            return g(a, [{
                ...
                value: function(a, b) {
                    var c = this,
                        ...
                        g = !(void 0 === e || null === e || "false" === e),
                        h = null !== a.rendererName && null !== a.rendererName.match(/(native|html5)/);
                    if (!d.created) {
                        if (d.created = !0, d.media = a, d.domNode = b, !(r.IS_ANDROID && d.options.AndroidUseNativeControls || r.IS_IPAD && d.options.iPadUseNativeControls || r.IS_IPHONE && d.options.iPhoneUseNativeControls)) {
                            var j = function() {
                                if (!d.isVideo && !d.options.features.length) return g && h && d.play(), d.options.success && ("string" == typeof d.options.success ? i["default"][d.options.success](d.media, d.domNode, d) : d.options.success(d.media, d.domNode, d)), {
                                    v: void 0
                                };
                                d.buildposter(d, d.controls, d.layers, d.media), d.buildkeyboard(d, d.controls, d.layers, d.media), d.buildoverlays(d, d.controls, d.layers, d.media), d.findTracks();
                                for (var a in d.options.features) {
                                    var b = d.options.features[a];
                                    if (d["build" + b]) try {
                                        d["build" + b](d, d.controls, d.layers, d.media)
                                    } catch (e) {
                                        console.error("error building " + b, e)
                                    }
                                }
                                d.container.trigger("controlsready"), d.setPlayerSize(d.width, d.height), d.setControlsSize(), d.isVideo && (r.HAS_TOUCH && !d.options.alwaysShowControls ? d.$media.on("touchstart", function() {
                                    d.controlsAreVisible ? d.hideControls(!1) : d.controlsEnabled && d.showControls(!1)
                                }) : (d.clickToPlayPauseCallback = function() {
                                    if (d.options.clickToPlayPause) {
                                        var a = d.$media.closest("." + d.options.classPrefix + "container").find("." + d.options.classPrefix + "overlay-button"),
                                            b = a.attr("aria-pressed");
                                        d.media.paused && b ? d.pause() : d.media.paused ? d.play() : d.pause(), a.attr("aria-pressed", !b)
                                    }
                                }, d.media.addEventListener("click", d.clickToPlayPauseCallback, !1), d.container.on("mouseenter", function() {
                                    d.controlsEnabled && (d.options.alwaysShowControls || (d.killControlsTimer("enter"), d.showControls(), d.startControlsTimer(d.options.controlsTimeoutMouseEnter)))
                                }).on("mousemove", function() {
                                    d.controlsEnabled && (d.controlsAreVisible || d.showControls(), d.options.alwaysShowControls || d.startControlsTimer(d.options.controlsTimeoutMouseEnter))
                                }).on("mouseleave", function() {
                                    d.controlsEnabled && (d.media.paused || d.options.alwaysShowControls || d.startControlsTimer(d.options.controlsTimeoutMouseLeave))
                                })), d.options.hideVideoControlsOnLoad && d.hideControls(!1), g && !d.options.alwaysShowControls && d.hideControls(), d.options.enableAutosize && d.media.addEventListener("loadedmetadata", function(a) {
                                    d.options.videoHeight <= 0 && !d.domNode.getAttribute("height") && !isNaN(a.target.videoHeight) && (d.setPlayerSize(a.target.videoWidth, a.target.videoHeight), d.setControlsSize(), d.media.setSize(a.target.videoWidth, a.target.videoHeight))
                                }, !1)), d.media.addEventListener("play", function() {
                                    d.hasFocus = !0;
                                    for (var a in m["default"].players) {
                                        var b = m["default"].players[a];
                                        b.id === d.id || !d.options.pauseOtherPlayers || b.paused || b.ended || (b.pause(), b.hasFocus = !1)
                                    }
                                }, !1), d.media.addEventListener("ended", function() {
                                    if (d.options.autoRewind) try {
                                        d.media.setCurrentTime(0), i["default"].setTimeout(function() {
                                            $(d.container).find("." + d.options.classPrefix + "overlay-loading").parent().hide()
                                        }, 20)
                                    } catch (a) {}
                                    "function" == typeof d.media.stop ? d.media.stop() : d.media.pause(), d.setProgressRail && d.setProgressRail(), d.setCurrentRail && d.setCurrentRail(), d.options.loop ? d.play() : !d.options.alwaysShowControls && d.controlsEnabled && d.showControls()
                                }, !1), d.media.addEventListener("loadedmetadata", function() {
                                    t.calculateTimeFormat(d.duration, d.options, d.options.framesPerSecond || 25), d.updateDuration && d.updateDuration(), d.updateCurrent && d.updateCurrent(), d.isFullScreen || (d.setPlayerSize(d.width, d.height), d.setControlsSize())
                                }, !1);
                                var f = null;
                                d.media.addEventListener("timeupdate", function() {
                                    f !== c.duration && (f = c.duration, t.calculateTimeFormat(f, d.options, d.options.framesPerSecond || 25), d.updateDuration && d.updateDuration(), d.updateCurrent && d.updateCurrent(), d.setControlsSize())
                                }, !1), d.container.focusout(function(a) {
                                    if (a.relatedTarget) {
                                        var b = $(a.relatedTarget);
                                        d.keyboardAction && 0 === b.parents("." + d.options.classPrefix + "container").length && (d.keyboardAction = !1, d.isVideo && !d.options.alwaysShowControls && d.hideControls(!0))
                                    }
                                }), setTimeout(function() {
                                    d.setPlayerSize(d.width, d.height), d.setControlsSize()
                                }, 50), d.globalBind("resize", function() {
                                    d.isFullScreen || r.HAS_TRUE_NATIVE_FULLSCREEN && k["default"].webkitIsFullScreen || d.setPlayerSize(d.width, d.height), d.setControlsSize()
                                }), d.globalBind("click", function(a) {
                                    $(a.target).is("." + d.options.classPrefix + "container") ? $(a.target).addClass(d.options.classPrefix + "container-keyboard-inactive") : $(a.target).closest("." + d.options.classPrefix + "container").length && $(a.target).closest("." + d.options.classPrefix + "container").addClass(d.options.classPrefix + "container-keyboard-inactive")
                                }), d.globalBind("keydown", function(a) {
                                    $(a.target).is("." + d.options.classPrefix + "container") ? $(a.target).removeClass(d.options.classPrefix + "container-keyboard-inactive") : $(a.target).closest("." + d.options.classPrefix + "container").length && $(a.target).closest("." + d.options.classPrefix + "container").removeClass(d.options.classPrefix + "container-keyboard-inactive")
                                }), null !== d.media.rendererName && d.media.rendererName.match(/youtube/) && (r.IS_IOS || r.IS_ANDROID) && (d.container.find("." + d.options.classPrefix + "overlay-play").hide(), d.container.find("." + d.options.classPrefix + "poster").hide())
                            }();
                            if ("object" === ("undefined" == typeof j ? "undefined" : f(j))) return j.v
                        }
                        g && h && d.play(), d.options.success && ("string" == typeof d.options.success ? i["default"][d.options.success](d.media, d.domNode, d) : d.options.success(d.media, d.domNode, d))
                    }
                }
            }, {
                key: "_handleError",
                ...
                value: function() {
                    ...
                    for (var c in a.options.features) {
                        var d = a.options.features[c];
                        if (a["clean" + d]) try {
                            a["clean" + d](a)
                        } catch (e) {
                            console.error("error cleaning " + d, e)
                        }
                    }
                    a.$node.css({
        ...
        i["default"].MediaElementPlayer = w, c["default"] = w,
            function(a) {
    ...
    17: [function(a, b, c) {
        ...
        var e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
            ...
            o = {
                ...
                enqueueIframe: function(a) {
                    o.isLoaded ? o.createIframe(a) : (o.loadIframeApi(), o.iframeQueue.push(a))
                },
                loadIframeApi: function() {
                    if (!o.isSDKStarted) {
                        var a = i["default"].createElement("script");
                        a.async = !0, a.src = "//api.dmcdn.net/all.js";
                        var b = i["default"].getElementsByTagName("script")[0];
                        b.parentNode.insertBefore(a, b), o.isSDKStarted = !0
                    }
                },
                apiReady: function() {
                    for (o.isLoaded = !0, o.isSDKLoaded = !0; o.iframeQueue.length > 0;) {
                        var a = o.iframeQueue.pop();
                        o.createIframe(a)
                    }
                },
                createIframe: function(a) {
                    var b = DM.player(a.container, {
                        height: a.height || "100%",
                        width: a.width || "100%",
                        video: a.videoId,
                    ...
                    b.addEventListener("apiready", function() {
                        g["default"]["__ready__" + a.id](b, {
                            paused: !0,
                            ended: !1
                        })
                    })
                },
                getDailyMotionId: function(a) {
                    var b = a.split("/"),
                        c = b[b.length - 1],
                        d = c.split("_");
                    return d[0]
            ...
            p = {
                ...
                canPlayType: function(a) {
                    return ["video/dailymotion", "video/x-dailymotion"].includes(a)
                },
                create: function(a, b, c) {
                    ...
                    var f = [],
                        ...
                        q = void 0,
                        r = void 0,
                        s = k["default"].html5media.properties,
                        t = function(b) {
                            ...
                            d["get" + c] = function() {
                                if (null !== j) {
                                    var c = null,
                                        d = function() {
                                            switch (b) {
                                                ...
                                                case "duration":
                                                    return {
                                                        v: isNaN(j.duration) ? 0 : j.duration
                                                    };
                                                case "volume":
                                                    return {
                                                        v: j.volume
                                                ...
                                                case "src":
                                                    return {
                                                        v: a.originalNode.getAttribute("src")
                                                    };
                                                case "readyState":
                                                    return {
                                                        v: p
                                    ...
                                    return "object" === ("undefined" == typeof d ? "undefined" : e(d)) ? d.v : c
                                }
                                return null
                            }, d["set" + c] = function(c) {
                                if (null !== j) switch (b) {
                                    case "src":
                                        ...
                                        j.load(o.getDailyMotionId(e));
                                        break;
                                    case "currentTime":
                                        j.seek(c);
                                        break;
                                    case "muted":
                                        c ? j.setMuted(!0) : j.setMuted(!1), setTimeout(function() {
                                            var b = m.createEvent("volumechange", d);
                                            a.dispatchEvent(b)
                                        }, 50);
                                        break;
                                    case "volume":
                                        j.setVolume(c), setTimeout(function() {
                                            var b = m.createEvent("volumechange", d);
                                            a.dispatchEvent(b);
                                        }, 50);
                                        break;
                                    case "readyState":
                                        var g = m.createEvent("canplay", vimeo);
                                        a.dispatchEvent(g)
                                } else f.push({
                                    type: "set",
                                    propName: b,
                    ...
                    for (q = 0, r = s.length; r > q; q++) t(s[q]);
                    var u = k["default"].html5media.methods,
                        v = function(a) {
                            d[a] = function() {
                                if (null !== j) switch (a) {
                                    case "play":
                    ...
                    for (q = 0, r = u.length; r > q; q++) v(u[q]);
                    g["default"]["__ready__" + d.id] = function(b) {
                        if (h = !0, a.dmPlayer = j = b, f.length)
                            for (q = 0, r = f.length; r > q; q++) {
                                var c = f[q];
                                if ("set" === c.type) {
                                    var e = c.propName,
                                        g = "" + e.substring(0, 1).toUpperCase() + e.substring(1);
                                    d["set" + g](c.value)
                                } else "call" === c.type && d[c.methodName]()
                            }
                        l = i["default"].getElementById(d.id), n = ["mouseover", "mouseout"];
                        var o = function(b) {
                            var c = m.createEvent(b.type, d);
                            a.dispatchEvent(c)
                        };
                        for (var p in n) m.addEvent(l, n[p], o);
                        n = k["default"].html5media.events, n = n.concat(["click", "mouseover", "mouseout"]);
                        var s = function(b) {
                            "ended" !== b && j.addEventListener(b, function(b) {
                                var c = m.createEvent(b.type, j);
                                a.dispatchEvent(c)
                            })
                        };
                        for (q = 0, r = n.length; r > q; q++) s(n[q]);
                        j.addEventListener("ad_start", function() {
                            var b = m.createEvent("play", j);
                            a.dispatchEvent(b), b = m.createEvent("progress", j), a.dispatchEvent(b), b = m.createEvent("timeupdate", j), a.dispatchEvent(b)
                        }), j.addEventListener("ad_timeupdate", function() {
                            var b = m.createEvent("timeupdate", j);
                            a.dispatchEvent(b)
                        }), j.addEventListener("ad_pause", function() {
                            var b = m.createEvent("pause", j);
                            a.dispatchEvent(b)
                        }), j.addEventListener("ad_end", function() {
                            var b = m.createEvent("ended", j);
                            a.dispatchEvent(b)
                        }), j.addEventListener("video_start", function() {
                            var b = m.createEvent("play", j);
                            a.dispatchEvent(b), b = m.createEvent("timeupdate", j), a.dispatchEvent(b)
                        }), j.addEventListener("video_end", function() {
                            var b = m.createEvent("ended", j);
                            a.dispatchEvent(b)
                        }), j.addEventListener("progress", function() {
                            var b = m.createEvent("timeupdate", j);
                            a.dispatchEvent(b)
                        }), j.addEventListener("durationchange", function() {
                            var b = m.createEvent("timeupdate", j);
                            a.dispatchEvent(b)
                        });
                        var t = ["rendererready", "loadeddata", "loadedmetadata", "canplay"];
                        for (q = 0, r = t.length; r > q; q++) {
                            var u = m.createEvent(t[q], d);
                            a.dispatchEvent(u)
                        }
                    };
                    var w = i["default"].createElement("div");
                    w.id = d.id, a.appendChild(w), a.originalNode && (w.style.width = a.originalNode.style.width, w.style.height = a.originalNode.style.height), a.originalNode.style.display = "none";
                    var x = o.getDailyMotionId(c[0].src),
                        y = Object.assign({
                            id: d.id,
                            container: w,
                            videoId: x,
                            autoplay: !!a.originalNode.getAttribute("autoplay")
                        }, d.options.dailymotion);
                    return o.enqueueIframe(y), d.hide = function() {
                        d.stopInterval(), d.pause(), l && (l.style.display = "none")
                    }, d.show = function() {
                        l && (l.style.display = "")
                    }, d.setSize = function(a, b) {
                        l.width = a, l.height = b
                    }, d.destroy = function() {
                        j.destroy()
                    }, d.interval = null, d.startInterval = function() {
                        d.interval = setInterval(function() {
                            o.sendEvent(d.id, j, "timeupdate", {
                                paused: !1,
                                ended: !1
                            })
                        }, 250)
        ...
        n.typeChecks.push(function(a) {
            return a = a.toLowerCase(), a.includes("//dailymotion.com") || a.includes("www.dailymotion.com") || a.includes("//dai.ly") ? "video/x-dailymotion" : null
        }), g["default"].dmAsyncInit = function() {
            o.apiReady()
        }, l.renderer.add(p)
    }, {
        2: 2,
        ...
        var e = a(3),
            ...
            o = {
                ...
                loadScript: function(a) {
                    o.isScriptLoaded || ("undefined" != typeof dashjs ? o.createInstance(a) : ! function() {
            ...
            p = {
                ...
                create: function(a, b, c) {
                    var d = null,
                        ...
                        n = void 0,
                        p = void 0;
                    d = e.cloneNode(!0), b = Object.assign(b, a.options);
                    var q = j["default"].html5media.properties,
                        r = function(a) {
                            var b = "" + a.substring(0, 1).toUpperCase() + a.substring(1);
                            d["get" + b] = function() {
                                return null !== i ? d[a] : null
                            }, d["set" + b] = function(b) {
                                null !== i ? ("src" === a && (i.attachSource(b), d.getAttribute("autoplay") && d.play()), d[a] = b) : m.push({
                                    type: "set",
                                    propName: a,
                                    value: b
                                })
                    ...
                    for (n = 0, p = q.length; p > n; n++) r(q[n]);
                    if (f["default"]["__ready__" + g] = function(c) {
                            if (a.dashPlayer = i = c, i.getDebug().setLogToBrowserConsole(b.dash.debug), m.length)
                                for (n = 0, p = m.length; p > n; n++) {
                                    var e = m[n];
                                    if ("set" === e.type) {
                                        var f = e.propName,
                                            g = "" + f.substring(0, 1).toUpperCase() + f.substring(1);
                                        d["set" + g](e.value)
                                    } else "call" === e.type && d[e.methodName]()
                                }
                            var k = j["default"].html5media.events,
                                o = dashjs.MediaPlayer.events,
                                q = function(b) {
                                    "loadedmetadata" === b && i.initialize(d, d.src, !1), d.addEventListener(b, function(b) {
                                        var c = h["default"].createEvent("HTMLEvents");
                                        c.initEvent(b.type, b.bubbles, b.cancelable), a.dispatchEvent(c)
                                    })
                                };
                            for (k = k.concat(["click", "mouseover", "mouseout"]), n = 0, p = k.length; p > n; n++) q(k[n]);
                            var r = function(b) {
                                var c = l.createEvent(b.type, d);
                                c.data = b, a.dispatchEvent(c), "error" === b.type.toLowerCase() && console.error(b)
                            };
                            for (var s in o) o.hasOwnProperty(s) && i.on(o[s], r)
                        }, c && c.length > 0)
                        for (n = 0, p = c.length; p > n; n++)
                            if (k.renderer.renderers[b.prefix].canPlayType(c[n].type)) {
                                d.setAttribute("src", c[n].src);
                                break
                            }
                    d.setAttribute("id", g), e.parentNode.insertBefore(d, e), e.removeAttribute("autoplay"), e.style.display = "none", o.prepareSettings({
                        options: b.dash,
                        id: g
                    }), d.setSize = function(a, b) {
                    ...
                    var s = l.createEvent("rendererready", d);
                    return a.dispatchEvent(s), d
                }
            };
    ...
    19: [function(a, b, c) {
        ...
        var e = a(3),
            ...
            o = {
                ...
                canPlayType: function(a) {
                    return ["video/facebook", "video/x-facebook"].includes(a)
                },
                create: function(a, b, c) {
                    function d(b) {
                        for (var c = 0, d = b.length; d > c; c++) {
                            var e = j["default"].Utils.createEvent(b[c], g);
                            a.dispatchEvent(e)
                        }
                    }

                    function e(b, c) {
                        r = b, k = h["default"].createElement("div"), k.id = g.id, k.className = "fb-video", k.setAttribute("data-href", b), k.setAttribute("data-allowfullscreen", "true"), k.setAttribute("data-controls", "false"), a.originalNode.parentNode.insertBefore(k, a.originalNode), a.originalNode.style.display = "none", f["default"].fbAsyncInit = function() {
                                FB.init(c), FB.Event.subscribe("xfbml.ready", function(a) {
                                    "video" === a.type && ! function() {
                                        i = a.instance;
                                        var b = k.getElementsByTagName("iframe")[0],
                                            c = parseInt(f["default"].getComputedStyle(b, null).width),
                                            e = parseInt(b.style.height);
                                        g.setSize(c, e), d(["mouseover", "mouseout"]);
                                        var h = ["startedPlaying", "paused", "finishedPlaying", "startedBuffering", "finishedBuffering"];
                                        for (u = 0, v = h.length; v > u; u++) {
                                            var j = h[u],
                                                m = s[j];
                                            void 0 === m || null === m || l.isObjectEmpty(m) || "function" != typeof m.removeListener || m.removeListener(j)
                                        }
                                        if (n.length)
                                            for (u = 0, v = n.length; v > u; u++) {
                                                var r = n[u];
                                                if ("set" === r.type) {
                                                    var t = r.propName,
                                                        w = "" + t.substring(0, 1).toUpperCase() + t.substring(1);
                                                    g["set" + w](r.value)
                                                } else "call" === r.type && g[r.methodName]()
                                            }
                                        d(["rendererready", "ready", "loadeddata", "canplay", "progress"]), d(["loadedmetadata", "timeupdate", "progress"]);
                                        var x = void 0;
                                        s.startedPlaying = i.subscribe("startedPlaying", function() {
                                            q || (q = !0), o = !1, p = !1, d(["play", "playing", "timeupdate"]), x = setInterval(function() {
                                                i.getCurrentPosition(), d(["timeupdate"])
                                            }, 250)
                                        }), s.paused = i.subscribe("paused", function() {
                                            o = !0, p = !1, d(["paused"])
                                        }), s.finishedPlaying = i.subscribe("finishedPlaying", function() {
                                            o = !0, p = !0, x = setInterval(function() {
                                                i.getCurrentPosition(), d(["timeupdate", "ended"])
                                            }, 250), clearInterval(x), x = null
                                        }), s.startedBuffering = i.subscribe("startedBuffering", function() {
                                            d(["progress", "timeupdate"])
                                        }), s.finishedBuffering = i.subscribe("finishedBuffering", function() {
                                            d(["progress", "timeupdate"])
                                        })
                                    }()
                                })
                            ...
                            }(h["default"], "script", "facebook-jssdk")
                    }
                    var g = {},
                        i = null,
                        k = null,
                        ...
                        u = void 0,
                        v = void 0;
                    b = Object.assign(b, a.options), g.options = b, g.id = a.id + "_" + b.prefix, g.mediaElement = a;
                    var w = j["default"].html5media.properties,
                        x = function(c) {
                            var d = "" + c.substring(0, 1).toUpperCase() + c.substring(1);
                            g["get" + d] = function() {
                                if (null !== i) {
                                    var a = null;
                                    switch (c) {
                                ...
                                if (null !== i) switch (c) {
                                    case "src":
                                        var f = "string" == typeof d ? d : d[0].src;
                                        k.parentNode.removeChild(k), e(f, b.facebook), FB.XFBML.parse();
                                        break;
                                    case "currentTime":
                                        i.seek(d);
                                        break;
                                    case "muted":
                                        d ? i.mute() : i.unmute(), setTimeout(function() {
                                            var b = m.createEvent("volumechange", g);
                                            a.dispatchEvent(b)
                                        }, 50);
                                        break;
                                    case "volume":
                                        i.setVolume(d), setTimeout(function() {
                                            var b = m.createEvent("volumechange", g);
                                            a.dispatchEvent(b)
                                        }, 50);
                                        break;
                                    case "readyState":
                                        var h = m.createEvent("canplay", vimeo);
                                        a.dispatchEvent(h)
                                } else n.push({
                                    type: "set",
                                    propName: c,
                    ...
                    for (u = 0, v = w.length; v > u; u++) x(w[u]);
                    var y = j["default"].html5media.methods,
                        z = function(a) {
                            g[a] = function() {
                                if (null !== i) switch (a) {
                                    case "play":
                    ...
                    for (u = 0, v = y.length; v > u; u++) z(y[u]);
                    return c.length > 0 && e(c[0].src, g.options.facebook), g.hide = function() {
                        g.stopInterval(), g.pause(), k && (k.style.display = "none")
                    }, g.show = function() {
                        k && (k.style.display = "")
                    }, g.setSize = function(a, b) {
                        null === i || isNaN(a) || isNaN(b) || (k.setAttribute("width", a), k.setAttribute("height", b))
                    }, g.destroy = function() {}, g.interval = null, g.startInterval = function() {
                        g.interval = setInterval(function() {
                            var b = m.createEvent("timeupdate", g);
                            a.dispatchEvent(b)
                        }, 250)
                    }, g.stopInterval = function() {
                        g.interval && clearInterval(g.interval)
                    }, g
                }
            };
        n.typeChecks.push(function(a) {
            return a = a.toLowerCase(), a.includes("//www.facebook") ? "video/x-facebook" : null
        }), k.renderer.add(o)
    }, {
        2: 2,
        28: 28,
        ...
        var s = {
                create: function(a, b, c) {
                    ...
                    g["default"]["__ready__" + d.id] = function() {
                        d.flashReady = !0, d.flashApi = i["default"].getElementById("__" + d.id);
                        var b = o.createEvent("rendererready", d);
                        if (a.dispatchEvent(b), d.flashApiStack.length)
                            for (var c = 0, e = d.flashApiStack.length; e > c; c++) {
                                var f = d.flashApiStack[c];
                                if ("set" === f.type) {
                                    var g = f.propName,
                                        h = "" + g.substring(0, 1).toUpperCase() + g.substring(1);
                                    d["set" + h](f.value)
                                } else "call" === f.type && d[f.methodName]()
                            }
                    ...
                    var t = !!a.getAttribute("autoplay"),
                        u = ["uid=" + d.id, "autoplay=" + t],
                        v = null !== a.originalNode && "video" === a.originalNode.tagName.toLowerCase(),
                        w = v ? a.originalNode.height : 1,
                        x = v ? a.originalNode.width : 1;
                    d.options.enablePseudoStreaming === !0 && (u.push("pseudostreamstart=" + d.options.pseudoStreamingStartQueryParam), u.push("pseudostreamtype=" + d.options.pseudoStreamingType)), a.appendChild(d.flashWrapper), v && null !== a.originalNode && (a.originalNode.style.display = "none");
                    var y = [];
                    if (p.IS_IE) {
                        var z = i["default"].createElement("div");
                        d.flashWrapper.appendChild(z), y = ['classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"', 'codebase="//download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab"', 'id="__' + d.id + '"', 'width="' + x + '"', 'height="' + w + '"'], v || y.push('style="clip: rect(0 0 0 0); position: absolute;"'), z.outerHTML = "<object " + y.join(" ") + ">" + ('<param name="movie" value="' + d.options.pluginPath + d.options.filename + "?x=" + new Date + '" />') + ('<param name="flashvars" value="' + u.join("&amp;") + '" />') + '<param name="quality" value="high" /><param name="bgcolor" value="#000000" /><param name="wmode" value="transparent" /><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="true" />' + ("<div>" + m["default"].t("mejs.install-flash") + "</div>") + "</object>"
                    } else y = ['id="__' + d.id + '"', 'name="__' + d.id + '"', 'play="true"', 'loop="false"', 'quality="high"', 'bgcolor="#000000"', 'wmode="transparent"', 'allowScriptAccess="always"', 'allowFullScreen="true"', 'type="application/x-shockwave-flash"', 'pluginspage="//www.macromedia.com/go/getflashplayer"', 'src="' + d.options.pluginPath + d.options.filename + '"', 'flashvars="' + u.join("&") + '"', 'width="' + x + '"', 'height="' + w + '"'], v || y.push('style="clip: rect(0 0 0 0); position: absolute;"'), d.flashWrapper.innerHTML = "<embed " + y.join(" ") + ">";
                    if (d.flashNode = d.flashWrapper.lastChild, d.hide = function() {
                            ...
                            d.flashNode.style.width = a + "px", d.flashNode.style.height = b + "px", null !== d.flashApi && d.flashApi.fire_setSize(a, b)
                        }, c && c.length > 0)
                        for (f = 0, h = c.length; h > f; f++)
                            if (n.renderer.renderers[b.prefix].canPlayType(c[f].type)) {
                                d.setSrc(c[f].src), d.load();
                                break
                            }
                    return d
                }
    ...
    21: [function(a, b, c) {
        ...
        var e = a(3),
            ...
            o = {
                ...
                loadScript: function(a) {
                    o.isMediaStarted || ("undefined" != typeof flvjs ? o.createInstance(a) : ! function() {
            ...
            p = {
                ...
                create: function(a, b, c) {
                    ...
                    var q = j["default"].html5media.properties,
                        r = function(a) {
                            ...
                            d["get" + b] = function() {
                                ...
                                null !== i ? (d[a] = b, "src" === a && (i.detachMediaElement(), i.attachMediaElement(d), i.load())) : m.push({
                                    type: "set",
                                    propName: a,
                                    value: b
                                })
                    ...
                    for (n = 0, p = q.length; p > n; n++) r(q[n]);
                    if (f["default"]["__ready__" + g] = function(b) {
                            if (a.flvPlayer = i = b, m.length)
                                for (n = 0, p = m.length; p > n; n++) {
                                    var c = m[n];
                                    if ("set" === c.type) {
                                        var e = c.propName,
                            ...
                            var g = j["default"].html5media.events,
                                k = function(b) {
                                    "loadedmetadata" === b && (i.detachMediaElement(), i.attachMediaElement(d), i.load()), d.addEventListener(b, function(b) {
                                        var c = h["default"].createEvent("HTMLEvents");
                                        c.initEvent(b.type, b.bubbles, b.cancelable), a.dispatchEvent(c)
                                    })
                                };
                            for (g = g.concat(["click", "mouseover", "mouseout"]), n = 0, p = g.length; p > n; n++) k(g[n])
                        }, c && c.length > 0)
                        for (n = 0, p = c.length; p > n; n++)
                            if (k.renderer.renderers[b.prefix].canPlayType(c[n].type)) {
                                d.setAttribute("src", c[n].src);
                    ...
                    d.setAttribute("id", g), e.parentNode.insertBefore(d, e), e.removeAttribute("autoplay"), e.style.display = "none", b.flv.type = "flv", b.flv.url = d.getAttribute("src"), o.prepareSettings({
                        options: b.flv,
                        id: g
                    }), d.setSize = function(a, b) {
                        return d.style.width = a + "px", d.style.height = b + "px", d
    ...
    22: [function(a, b, c) {
        ...
        var e = a(3),
            ...
            o = {
                ...
                loadScript: function(a) {
                    o.isMediaStarted || ("undefined" != typeof Hls ? o.createInstance(a) : ! function() {
                ...
                create: function(a, b, c) {
                    ...
                    var q = j["default"].html5media.properties,
                        r = function(a) {
                            ...
                            d["get" + c] = function() {
                                ...
                                null !== i ? (d[a] = c, "src" === a && (i.destroy(), i = null, i = o.createInstance({
                                    options: b.hls,
                                    id: g
                                }), i.attachMedia(d), i.on(Hls.Events.MEDIA_ATTACHED, function() {
                                    i.loadSource(c)
                                }))) : m.push({
                                    type: "set",
                                    propName: a,
                    ...
                    if (f["default"]["__ready__" + g] = function(b) {
                            ...
                            var g = j["default"].html5media.events,
                                k = Hls.Events,
                                o = function(b) {
                                    "loadedmetadata" === b && ! function() {
                                        i.detachMedia();
                                        var a = d.src;
                                        i.attachMedia(d), i.on(k.MEDIA_ATTACHED, function() {
                                            i.loadSource(a)
                                        })
                            ...
                            for (g = g.concat(["click", "mouseover", "mouseout"]), n = 0, p = g.length; p > n; n++) o(g[n]);
                            var q = function(b, c) {
                                var e = l.createEvent(b, d);
                                if (e.data = c, a.dispatchEvent(e), "hlsError" === b)
                                    if (console.error(b, c), c.fatal) i.destroy();
                                    else switch (c.type) {
                                        case "mediaError":
                                            i.recoverMediaError();
                                            break;
                            ...
                            for (var r in k) k.hasOwnProperty(r) && i.on(k[r], q)
                        }, c && c.length > 0)
                        for (n = 0, p = c.length; p > n; n++)
                            if (k.renderer.renderers[b.prefix].canPlayType(c[n].type)) {
                                d.setAttribute("src", c[n].src);
    ...
    24: [function(a, b, c) {
        ...
        var e = a(3),
            ...
            n = {
                ...
                iframeQueue: [],
                enqueueIframe: function(a) {
                    n.isLoaded ? n.createIframe(a) : (n.loadIframeApi(), n.iframeQueue.push(a))
                },
                loadIframeApi: function() {
                    n.isSDKStarted || ! function() {
                        var a = h["default"].getElementsByTagName("head")[0] || h["default"].documentElement,
                            b = h["default"].createElement("script"),
                            c = !1;
                        b.src = "//w.soundcloud.com/player/api.js", b.onload = b.onreadystatechange = function() {
                            c || n.readyState && "loaded" !== n.readyState && "complete" !== n.readyState || (c = !0, n.apiReady(), b.onload = b.onreadystatechange = null, a && b.parentNode && a.removeChild(b))
                        }, a.appendChild(b), n.isSDKStarted = !0
                    }()
                },
                apiReady: function() {
                    for (n.isLoaded = !0, n.isSDKLoaded = !0; n.iframeQueue.length > 0;) {
                        var a = n.iframeQueue.pop();
                        n.createIframe(a)
                    }
                },
                createIframe: function(a) {
                    var b = SC.Widget(a.iframe);
                    f["default"]["__ready__" + a.id](b)
                }
            },
            o = {
                ...
                canPlayType: function(a) {
                    return ["video/soundcloud", "video/x-soundcloud"].includes(a)
                },
                create: function(a, b, c) {
                    var d = {};
                    d.options = b, d.id = a.id + "_" + b.prefix, d.mediaElement = a;
                    var e = [],
                        ...
                        v = void 0,
                        w = void 0,
                        x = j["default"].html5media.properties,
                        y = function(b) {
                            var c = "" + b.substring(0, 1).toUpperCase() + b.substring(1);
                            d["get" + c] = function() {
                                if (null !== i) {
                                ...
                                if (null !== i) switch (b) {
                                    ...
                                    case "currentTime":
                                        ...
                                        break;
                                    case "muted":
                                        c ? i.setVolume(0) : i.setVolume(1), setTimeout(function() {
                                            var b = l.createEvent("volumechange", d);
                                            a.dispatchEvent(b)
                                        }, 50);
                                        break;
                                    case "volume":
                                        i.setVolume(c), setTimeout(function() {
                                            var b = l.createEvent("volumechange", d);
                                            a.dispatchEvent(b)
                                        }, 50);
                                        break;
                                    case "readyState":
                                        var g = l.createEvent("canplay", vimeo);
                                        a.dispatchEvent(g)
                                } else e.push({
                                    type: "set",
                                    propName: b,
                    ...
                    for (v = 0, w = x.length; w > v; v++) y(x[v]);
                    var z = j["default"].html5media.methods,
                        A = function(a) {
                            d[a] = function() {
                                if (null !== i) switch (a) {
                                    case "play":
                    ...
                    for (v = 0, w = z.length; w > v; v++) A(z[v]);
                    f["default"]["__ready__" + d.id] = function(b) {
                        if (g = !0, a.scPlayer = i = b, e.length)
                            for (v = 0, w = e.length; w > v; v++) {
                                var c = e[v];
                                if ("set" === c.type) {
                                    var f = c.propName,
                        ...
                        i.bind(SC.Widget.Events.PLAY_PROGRESS, function() {
                            q = !1, t = !1, i.getPosition(function(b) {
                                m = b / 1e3;
                                var c = l.createEvent("timeupdate", d);
                                a.dispatchEvent(c)
                            })
                        }), i.bind(SC.Widget.Events.PAUSE, function() {
                            q = !0;
                            var b = l.createEvent("pause", d);
                            a.dispatchEvent(b)
                        }), i.bind(SC.Widget.Events.PLAY, function() {
                            q = !1, t = !1;
                            var b = l.createEvent("play", d);
                            a.dispatchEvent(b)
                        }), i.bind(SC.Widget.Events.FINISHED, function() {
                            q = !1, t = !0;
                            var b = l.createEvent("ended", d);
                            a.dispatchEvent(b)
                        }), i.bind(SC.Widget.Events.READY, function() {
                            i.getDuration(function(b) {
                                o = b / 1e3;
                                var c = l.createEvent("loadedmetadata", d);
                                a.dispatchEvent(c)
                            })
                        }), i.bind(SC.Widget.Events.LOAD_PROGRESS, function() {
                            i.getDuration(function(b) {
                                if (o > 0) {
                                    p = o * b;
                                    var c = l.createEvent("progress", d);
                                    a.dispatchEvent(c)
                                }
                            }), i.getDuration(function(b) {
                                o = b;
                        ...
                        for (var j = ["rendererready", "loadeddata", "loadedmetadata", "canplay"], k = 0, n = j.length; n > k; k++) {
                            var r = l.createEvent(j[k], d);
                            a.dispatchEvent(r)
                        }
                    }, k = h["default"].createElement("iframe"), k.id = d.id, k.width = 10, k.height = 10, k.frameBorder = 0, k.style.visibility = "hidden", k.src = c[0].src, k.scrolling = "no", a.appendChild(k), a.originalNode.style.display = "none";
                    var B = {
                        iframe: k,
                        id: d.id
                    };
                    return n.enqueueIframe(B), d.setSize = function(a, b) {}, d.hide = function() {
                        d.pause(), k && (k.style.display = "none")
                    }, d.show = function() {
                        k && (k.style.display = "")
                    }, d.destroy = function() {
                        i.destroy()
        ...
        m.typeChecks.push(function(a) {
            return a = a.toLowerCase(), a.includes("//soundcloud.com") || a.includes("//w.soundcloud.com") ? "video/x-soundcloud" : null
        }), k.renderer.add(o)
    }, {
        2: 2,
        28: 28,
    ...
    25: [function(a, b, c) {
        ...
        var e = a(3),
            ...
            n = {
                ...
                loadIframeApi: function() {
                    n.isIframeStarted || ! function() {
                        var a = h["default"].createElement("script"),
                            b = h["default"].getElementsByTagName("script")[0],
                            c = !1;
                        a.src = "//player.vimeo.com/api/player.js", a.onload = a.onreadystatechange = function() {
                            c || n.readyState && void 0 !== n.readyState && "loaded" !== n.readyState && "complete" !== n.readyState || (c = !0, n.iFrameReady(), a.onload = a.onreadystatechange = null)
                        }, b.parentNode.insertBefore(a, b), n.isIframeStarted = !0
                    }()
                },
                iFrameReady: function() {
                    for (n.isLoaded = !0, n.isIframeLoaded = !0; n.iframeQueue.length > 0;) {
                        var a = n.iframeQueue.pop();
                        n.createIframe(a)
                    }
                },
                createIframe: function(a) {
                    var b = new Vimeo.Player(a.iframe);
                    f["default"]["__ready__" + a.id](b)
                },
                getVimeoId: function(a) {
                    if (void 0 === a || null === a) return null;
                    var b = a.split("?");
                    return a = b[0], parseInt(a.substring(a.lastIndexOf("/") + 1))
                },
                errorHandler: function(a, b) {
                    var c = l.createEvent("error", b);
                    c.message = a.name + ": " + a.message, mediaElement.dispatchEvent(c)
                }
            },
            o = {
                name: "vimeo_iframe",
                ...
                canPlayType: function(a) {
                    return ["video/vimeo", "video/x-vimeo"].includes(a)
                },
                create: function(a, b, c) {
                    var d = [],
                        e = !1,
                        ...
                        v = void 0,
                        w = void 0;
                    g.options = b, g.id = a.id + "_" + b.prefix, g.mediaElement = a;
                    var x = j["default"].html5media.properties,
                        y = function(b) {
                            var c = "" + b.substring(0, 1).toUpperCase() + b.substring(1);
                            g["get" + c] = function() {
                                if (null !== i) {
                                    ...
                                    switch (b) {
                                        ...
                                        case "ended":
                                            return r;
                                        case "src":
                                            return i.getVideoUrl().then(function(a) {
                                                t = a
                                            }), t;
                                        case "buffered":
                                            return {
                                ...
                                if (null !== i) switch (b) {
                                    case "src":
                                        var e = "string" == typeof c ? c : c[0].src,
                                            f = n.getVimeoId(e);
                                        i.loadVideo(f).then(function() {
                                            a.getAttribute("autoplay") && i.play()
                                        })["catch"](function(a) {
                                            n.errorHandler(a, g)
                                        });
                                        break;
                                    case "currentTime":
                                        i.setCurrentTime(c).then(function() {
                                            p = c, setTimeout(function() {
                                                var b = l.createEvent("timeupdate", g);
                                                a.dispatchEvent(b)
                                            }, 50)
                                        })["catch"](function(a) {
                                            n.errorHandler(a, g)
                                        ...
                                        break;
                                    case "volume":
                                        i.setVolume(c).then(function() {
                                            m = c, o = m, setTimeout(function() {
                                                var b = l.createEvent("volumechange", g);
                                                a.dispatchEvent(b)
                                            }, 50)
                                        })["catch"](function(a) {
                                            n.errorHandler(a, g)
                                        ...
                                        break;
                                    case "loop":
                                        i.setLoop(c)["catch"](function(a) {
                                            n.errorHandler(a, g)
                                        });
                                        break;
                                    case "muted":
                                        c ? i.setVolume(0).then(function() {
                    ...
                    for (v = 0, w = z.length; w > v; v++) A(z[v]);
                    f["default"]["__ready__" + g.id] = function(b) {
                        if (e = !0, a.vimeoPlayer = i = b, d.length)
                            for (v = 0, w = d.length; w > v; v++) {
                                var c = d[v];
                                if ("set" === c.type) {
                                    var f = c.propName,
                                        j = "" + f.substring(0, 1).toUpperCase() + f.substring(1);
                                    g["set" + j](c.value)
                                } else "call" === c.type && g[c.methodName]()
                            }
                        var m = h["default"].getElementById(g.id),
                            o = void 0;
                        o = ["mouseover", "mouseout"];
                        var t = function(b) {
                            var c = l.createEvent(b.type, g);
                            a.dispatchEvent(c)
                        };
                        for (var u in o) {
                            var x = o[u];
                        ...
                        for (i.on("loaded", function() {
                                i.getDuration().then(function(b) {
                                    s = b, s > 0 && (q = s * b);
                                    var c = l.createEvent("loadedmetadata", g);
                                    a.dispatchEvent(c)
                                })["catch"](function(a) {
                                    n.errorHandler(a, g)
                                })
                                ...
                                i.getDuration().then(function(b) {
                                    s = b, s > 0 && (q = s * b);
                                    var c = l.createEvent("progress", g);
                                    a.dispatchEvent(c)
                                })["catch"](function(a) {
                                    n.errorHandler(a, g)
                                })
                            }), i.on("timeupdate", function() {
                                i.getCurrentTime().then(function(a) {
                                    p = a
                                });
                                var b = l.createEvent("timeupdate", g);
                                a.dispatchEvent(b)
                                ...
                                k = !1, r = !1;
                                var b = l.createEvent("play", g);
                                a.dispatchEvent(b), b = l.createEvent("playing", g), a.dispatchEvent(b)
                            }), i.on("pause", function() {
                                k = !0, r = !1;
                                var b = l.createEvent("pause", g);
                                a.dispatchEvent(b)
                            }), i.on("ended", function() {
                                k = !1, r = !0;
                                var b = l.createEvent("ended", g);
                                a.dispatchEvent(b)
                            }), o = ["rendererready", "loadeddata", "loadedmetadata", "canplay"], v = 0, w = o.length; w > v; v++) {
                            var y = l.createEvent(o[v], g);
                            a.dispatchEvent(y)
                        }
                    };
                    var B = a.originalNode.height,
                        C = a.originalNode.width,
                        D = h["default"].createElement("iframe"),
                        E = "//player.vimeo.com/video/" + n.getVimeoId(c[0].src),
                        F = c[0].src.includes("?") ? "?" + c[0].src.slice(c[0].src.indexOf("?") + 1) : "";
                    return D.setAttribute("id", g.id), D.setAttribute("width", C), D.setAttribute("height", B), D.setAttribute("frameBorder", "0"), D.setAttribute("src", "" + E + F), D.setAttribute("webkitallowfullscreen", ""), D.setAttribute("mozallowfullscreen", ""), D.setAttribute("allowfullscreen", ""), a.originalNode.parentNode.insertBefore(D, a.originalNode), a.originalNode.style.display = "none", n.enqueueIframe({
                        iframe: D,
                        id: g.id
                    }), g.hide = function() {
                        g.pause(), i && (D.style.display = "none")
                    }, g.setSize = function(a, b) {
                        D.setAttribute("width", a), D.setAttribute("height", b)
                    }, g.show = function() {
                        i && (D.style.display = "")
                    }, g
                }
        ...
        m.typeChecks.push(function(a) {
            return a = a.toLowerCase(), a.includes("//player.vimeo") || a.includes("vimeo.com") ? "video/x-vimeo" : null
        }), k.renderer.add(o)
    }, {
        2: 2,
        28: 28,
        ...
        var e = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(a) {
            ...
            o = {
                ...
                getYouTubeIdFromParam: function(a) {
                    ...
                    for (var b = "", c = a.split("?"), d = c[1].split("&"), e = 0, f = d.length; f > e; e++) {
                        var g = d[e].split("=");
                        if ("v" === g[0]) {
                            b = g[1];
                            break
            ...
            p = {
                ...
                create: function(a, b, c) {
                    ...
                    var f = [],
                        ...
                        s = void 0,
                        t = void 0,
                        u = k["default"].html5media.properties,
                        v = function(b) {
                            var c = "" + b.substring(0, 1).toUpperCase() + b.substring(1);
                            d["get" + c] = function() {
                                if (null !== h) {
                                    var a = null,
                                        c = function() {
                                            switch (b) {
                                                ...
                                                case "buffered":
                                                    var a = h.getVideoLoadedFraction(),
                                                        c = h.getDuration();
                                                    return {
                                                        v: {
                                                            start: function() {
                                ...
                                if (null !== h) switch (b) {
                                    case "src":
                                        var e = "string" == typeof c ? c : c[0].src,
                                            g = o.getYouTubeId(e);
                                        a.getAttribute("autoplay") ? h.loadVideoById(g) : h.cueVideoById(g);
                                        break;
                                    case "currentTime":
                                        h.seekTo(c);
                                        break;
                                    case "muted":
                                        c ? h.mute() : h.unMute(), setTimeout(function() {
                                            var b = m.createEvent("volumechange", d);
                                            a.dispatchEvent(b)
                                        }, 50);
                                        break;
                                    case "volume":
                                        q = c, h.setVolume(100 * c), setTimeout(function() {
                                            var b = m.createEvent("volumechange", d);
                                            a.dispatchEvent(b)
                                        }, 50);
                                        break;
                                    case "readyState":
                                        var i = m.createEvent("canplay", vimeo);
                                        a.dispatchEvent(i)
                                } else f.push({
                                    type: "set",
                                    propName: b,
                    ...
                    for (s = 0, t = u.length; t > s; s++) v(u[s]);
                    var w = k["default"].html5media.methods,
                        x = function(a) {
                            d[a] = function() {
                                if (null !== h) switch (a) {
                                    case "play":
                    ...
                    for (s = 0, t = w.length; t > s; s++) x(w[s]);
                    var y = i["default"].createElement("div");
                    y.id = d.id, d.options.youtube.nocookie && a.originalNode.setAttribute("src", o.getYouTubeNoCookieUrl(c[0].src)), a.originalNode.parentNode.insertBefore(y, a.originalNode), a.originalNode.style.display = "none";
                    var z = a.originalNode.height,
                        A = a.originalNode.width,
                        B = o.getYouTubeId(c[0].src),
                        C = {
                            id: d.id,
                            containerId: y.id,
                            videoId: B,
                            ...
                            events: {
                                onReady: function(b) {
                                    if (j = !0, a.youTubeApi = h = b.target, a.youTubeState = {
                                            paused: !0,
                                            ended: !1
                                        }, f.length)
                                        for (s = 0, t = f.length; t > s; s++) {
                                            var c = f[s];
                                            if ("set" === c.type) {
                                                var e = c.propName,
                                                    g = "" + e.substring(0, 1).toUpperCase() + e.substring(1);
                                    ...
                                    p = h.getIframe();
                                    var i = ["mouseover", "mouseout"],
                                        k = function(b) {
                                            var c = m.createEvent(b.type, d);
                                            a.dispatchEvent(c)
                                        };
                                    for (var l in i) m.addEvent(p, i[l], k);
                                    var n = ["rendererready", "loadeddata", "loadedmetadata", "canplay"];
                                    for (s = 0, t = n.length; t > s; s++) {
                                        var o = m.createEvent(n[s], d);
                                        a.dispatchEvent(o)
                                    }
                                },
                                onStateChange: function(b) {
                                    ...
                                    switch (b.data) {
                                        ...
                                        case 1:
                                            ...
                                            break;
                                        case 2:
                                            c = ["paused"], l = !0, n = !1, d.stopInterval();
                                            break;
                                        case 3:
                                            c = ["progress"], l = !1, n = !1;
                                            break;
                    ...
                    return o.enqueueIframe(C), d.onEvent = function(b, c, d) {
                        null !== d && void 0 !== d && (a.youTubeState = d)
                    }, d.setSize = function(a, b) {
                        null !== h && h.setSize(a, b)
                    }, d.hide = function() {
    ...
    27: [function(a, b, c) {
        ...
        var B = c.SUPPORTS_MEDIA_TAG = void 0 !== y.canPlayType || v,
            C = c.SUPPORTS_NATIVE_HLS = s || o && (q || t) || p && null !== l.match(/edge/gi),
            D = void 0 !== y.webkitEnterFullscreen,
            E = void 0 !== y.requestFullscreen;
        D && l.match(/mac os x 10_5/i) && (E = !1, D = !1);
        var F = void 0 !== y.webkitRequestFullScreen,
            G = void 0 !== y.mozRequestFullScreen,
            H = void 0 !== y.msRequestFullscreen,
            I = F || G || H,
            J = I,
            K = "",
            L = void 0,
    ...
    32: [function(a, b, c) {
        ...
        function g(a, b) {
            ...
            a = !a || "number" != typeof a || 0 > a ? 0 : a;
            for (var d = !1, e = b.timeFormat, f = e[0], g = e[1] === e[0], h = g ? 2 : 1, i = e.length < h ? e[h] : ":", j = Math.floor(a / 3600) % 24, k = Math.floor(a / 60) % 60, l = Math.floor(a % 60), m = Math.floor((a % 1 * c).toFixed(3)), n = [
                    [m, "f"],
                    [l, "s"],
                    [k, "m"],
                    [j, "h"]
                ], o = 0, p = n.length; p > o; o++)
